...
#    print()
    ...
    exporand = arrgetrand(arrlambda, rep) #time till next arr in addittional hrs
...
#    print()
#    print('curarrseed: z = ', curarrseed)
##    print()
    
    if rep < (numreps/2):
        curarrseed = curarrseed
##        print()
#        print('curarrseed less than: z = ', curarrseed)
        zarrused.append(curarrseed)
#        print()
    elif rep == (numreps/2) and aparrrepcnt == 0:
        curarrseed = 50001
#        print('aparrrepcnt = ', aparrrepcnt)
#        print('curarrseed equal to: z = ', curarrseed)
        zarrused.append(curarrseed)
#        print()
        aparrrepcnt += 1
#        print('aparrrepcnt after = ', aparrrepcnt)
    elif rep == (numreps/2) and aparrrepcnt > 0:
        curarrseed = curarrseed
##        print()
#        print('aparrrepcnt = ', aparrrepcnt)
...
##    print()
    ...
    if rep < (numreps/2):
        arrlcgnum = arrlcgnum
##        print()
#        print('arrlcgnum unif = ', arrlcgnum)
##        print()
        unifarrused.append(arrlcgnum)
    else:
        arrlcgnum = (1 - arrlcgnum)
##        print()
#        print('arrlcgnum (1 - unif) = ', arrlcgnum)
##        print()
...
#    print()
#    print('curdepseed: z = ', curdepseed)
##    print()
    
    if rep < (numreps/2):
        curdepseed = curdepseed
##        print()
#        print('curdepseed less than: z = ', curdepseed)
        zdepused.append(curdepseed)
#        print()
    elif rep == (numreps/2) and apdeprepcnt == 0:
        curdepseed = 94907
#        print('apdeprepcnt = ', apdeprepcnt)
#        print('curdepseed equal to: z = ', curdepseed)
        zdepused.append(curdepseed)
#        print()
        apdeprepcnt += 1
#        print('apdeprepcnt after = ', apdeprepcnt)
    elif rep == (numreps/2) and apdeprepcnt > 0:
        curdepseed = curdepseed
##        print()
#        print('apdeprepcnt = ', apdeprepcnt)
...
#    print()
#    print('deplcgnum = ', deplcgnum)
##    print()
    
    if rep < (numreps/2):
        deplcgnum = deplcgnum
##        print()
#        print('deplcgnum unif = ', deplcgnum)
##        print()
        unifdepused.append(deplcgnum)
    else:
        deplcgnum = (1 - deplcgnum)
##        print()
#        print('deplcgnum (1 - unif) = ', deplcgnum)
##        print()
...
#zarrused = map(int, zarrused)
#print('zarrused = ', zarrused)
#print()
#
#zdepused = map(int, zdepused)
#print('zdepused = ', zdepused)
#print()
#
#print('unifarrused = ', unifarrused)
#print()
#print('oneminunifarrused = ', oneminunifarrused)
#print()
#print('unifdepused = ', unifdepused)
#print()
#print('oneminunifdepused = ', oneminunifdepused)
#print()
