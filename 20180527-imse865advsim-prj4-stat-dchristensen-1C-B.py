...
for cirep in range (0,numcireps):
    ...
    #    print('*****************************')
    ##    print('told = ', told) #the most recent current time in minutes
    #    print('tnow = ', tnow) #the current time in minutes
    ##    print('tmax = ', tmax)
    ##    print('nextarr = ', nextarr)
    ##    print('nextdep = ', nextdep)
    ##    print('util = ', util)
    ...
    #    print('*****************************') 
        ...
        warmtnow = tnow
        warmwaittime = waittime
        warmcumutil = cumutil
        warmcumsystime = cumsystime
        warmcumarr = cumarr
        ...
        hours = 500
        tmax = tnow + (hours * 60) #max time to end program in minutes   #9600
...
#    #    print('*****************************')
        ...
        tnow -= warmtnow
        waittime -= warmwaittime
        cumutil -= warmcumutil
        cumsystime -= warmcumsystime
        cumarr -= warmcumarr
...
#    print()
    ...
    alpha = 0.051  # 1 - Confidence Level
...
#----- THESE LINES DON'T GET INDENTED -----#
print()
