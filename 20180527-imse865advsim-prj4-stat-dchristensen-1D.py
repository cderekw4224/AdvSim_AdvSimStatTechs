...
#        print('tnow = ', tnow)
        ...
        if tnow >= batchtime:
            ...
            print()
            batchnum += 1
            print('batchnum = ', batchnum+1, 'ends at tnow = ', tnow)
            print()
            print('cumarr = ', cumarr)
            print()
            print('sysprevtnow = ', sysprevtnow)
            print()
            ...
            print()
            print('sysprevwaittime = ', sysprevwaittime)
            
            #assign data to batchcur = syscur - sysprev
            batchtnow = tnow - sysprevtnow
            print()
            print('batchwaittime = waittime - sysprevwaittime')
            print()
            ...
            print('batchtnow = ', batchtnow)
            print('batchwaittime = ', batchwaittime)
            print('batchcumutil = ', batchcumutil)
            print('batchcumsystime = ', batchcumsystime)
            print('batchcumarr = ', batchcumarr)
            ...
            print('batchavgqtime = ', batchavgqtime)
            print('batchavgsystime = ', batchavgsystime)
            print('batchavgqlen = ', batchavgqlen)
            print('batchavgutil = ', batchavgutil)
    ...
    print()
    print('tnow_batch =', tnow_batch)
    print()
    print('avgqtimeary_batch =', avgqtimeary_batch)
    print()
    print('avgsystimeary_batch =', avgsystimeary_batch)
    print()
    print('avgqlenary_batch =', avgqlenary_batch)
    print()
    print('avgutilary_batch =', avgutilary_batch)
    print()
    print('cumarr_batch =', cumarr_batch)
    print()
